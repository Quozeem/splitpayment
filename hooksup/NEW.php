...
include_once "config.php";
     ...
     if ($firstname ||  $lastname ||   $phonemail  ||  $password) {

   }
	$update="INSERT INTO hooked (firstname,lastname,phonemail,password) VALUES ('$firstname','$lastname','$phonemail','$password')";
 ...
 ?>
  ...
  <td>
   <a href="update.php?edit=<?php echo $row['id'] ;?>">Edit</a>
    <a href="NEW.php?del=<?php echo $row['id'] ;?>">Delete</a>
